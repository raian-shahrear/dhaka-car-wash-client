...
import { MdOutlineClose, MdOutlineLogout, MdOutlineSpaceDashboard } from "react-icons/md";
      ...
      <div className="p-3 pt-8">
        <ul className="flex flex-col gap-2">
          <li>
            ...
            >
              <span className="text-lg"><MdOutlineSpaceDashboard /></span>
              <span>Dashboard</span>
            </NavLink>
          </li>
          <li>
          ...
          <li>
            ...
            >
              <span className="text-lg"><FaTimeline /></span>
              Slot Management
            </NavLink>
          </li>
          <li>
            ...
            <ul className="ms-10 mt-2 flex flex-col gap-2">
              <li>
                ...
                >
                  <span className="text-xs"><FaRegCircle /></span>
                  <span>Bookings</span>
                </NavLink>
              </li>
              <li>
